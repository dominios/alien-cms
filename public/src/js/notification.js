            ...
            function ($timeout, $templateCache) {
                if (!$templateCache.get('ng-notification-template')) {
                    $templateCache.put('ng-notification-template',
                        ...
                        '<strong class="title">' +
                        '<i ng-show="noti.icon==\'success\'" class="fa fa-fw fa-check"></i> ' +
                        '<i ng-show="noti.icon==\'warning\'"  class="fa fa-fw fa-warning"></i> ' +
                        '<i ng-show="noti.icon==\'info\'"  class="fa fa-fw fa-info"></i> ' +
                        '<i ng-show="noti.icon==\'error\'"  class="fa fa-fw fa-ban"></i> ' +
                        '{{noti.title}}' +
                        '</strong>' +
                        ' <span ng-bind="noti.content"></span> ' +
                        '</div>' +
                        '</div>' +
                        '</div>'
                    );
